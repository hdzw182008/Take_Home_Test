            ...
            <div class="flex flex-col md-w-1/2 h-auto ">
                ...
                <form action="/dokter/{{ $dokter->id }}" method="POST">
                    ...
                    @method('PUT')
                        ...
                        <div class="mt-2">
                            <input type="text" name="kode" autocomplete="given-name" value="{{ $dokter->kode }}" class="w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" readonly/>
                        <label for="first-name" class="block text-sm/6 font-medium text-gray-900">Nama</label>
                        <div class="mt-2">
                            <input type="text" name="nama" autocomplete="given-name" value="{{ $dokter->nama }}" class="w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 @error('nama') border-2 border-red-500 @enderror" />
                             @error('nama')
                        ...
                        <div class="mt-2">
                            <input type="text" value="{{ $dokter->spesialis }}" name="spesialis" autocomplete="given-name" class="w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 @error('spesialis') border-2 border-red-500 @enderror" />
                            @error('spesialis')
                                <small class="mt-0 mb-2">{{$message}}</small>
                            @enderror
                        </div>
                        ...
                        <div class="mt-2">
                            <input type="number" value="{{ $dokter->kontak }}" name="kontak" autocomplete="given-name" class="w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 @error('kontak') border-2 border-red-500 @enderror" />
                            @error('kontak')
                                <small class="mt-0 mb-2">{{$message}}</small>
                            @enderror
                        </div>
