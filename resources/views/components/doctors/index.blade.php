<x-app>
    <div class="container mx-auto px-4 sm:px-8">
        ...
        <div class="py-8">
            <div>
                <h2 class="text-2xl font-semibold leading-tight">Data Dokter</h2>
            </div>
            <div class="my-2 flex sm:flex-row flex-col">
                  <form action="/dokter" method="GET" class="lg:w-1/2 md:w-full sm:w-full flex mb-1">
                    @csrf
                ...
                <div class="flex justify-end lg:w-1/2 md:w-full sm:w-full mb-1">
                    <a href="/dokter/create" class="btnAdd bg-blue-500 hover:bg-blue-700 text-white mr-2 py-2 px-2 rounded">Tambah Dokter</a>            
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr colspan="8">
                                ...
                                <td class="px-8 py-8 border-b border-gray-200 bg-white">
                                    <a href="/dokter/{{ $dokter->slug }}/edit" class="bg-yellow-500 hover:bg-yellow-700 text-white py-1 px-3 mt-1 rounded">Edit</a>
                                    <form onsubmit="return confirm('Hapus data?')" action="/dokter/{{ $dokter->slug }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
