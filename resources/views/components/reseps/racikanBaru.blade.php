    ...
    <div>
        <div class="container mx-auto px-4 sm:px-8">
            <div class="flex flex-col md-w-1/2 h-auto ">
                ...
                <form action="/racikanBaru/create" method="POST" class="bg-white py-2 px-4 rounded">
                    @csrf
                                    ...
                                    <tbody>
                                        @forelse ($certainMedicine as $item)
                                            <tr class="border-1">
                                                ...
                                                <td><input required type="number" class="@error('nama') border-2 border-red-500 @enderror" placeholder="Qty..." value="{{ $item->qty ?? old('qty')}}" name="qty[]">
                                                 @error('qty')
                                                    <small class="mt-0 mb-2">{{$message}}</small>
                                                @enderror
                                                </td>
                ...
                <div class="mt-8">
                    <div class="my-2 flex sm:flex-row flex-col">
                            <form action="/racikanBaru" method="GET" class="lg:w-1/2 md:w-full sm:w-full flex mb-1">
                                @csrf
